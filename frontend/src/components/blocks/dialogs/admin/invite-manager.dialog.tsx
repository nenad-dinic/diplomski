...
interface AdminInviteManagerDialogProps {
...
export default function AdminInviteManagerDialog(props : AdminInviteManagerDialogProps) {
    ...
    async function handleFormSubmit(data : InviteFormData) {
        ...
        const invite = await InviteService.inviteManager(data.email, props.buildingId);
