...
interface ManagerInviteOwnerDialogProps {
...
export default function ManagerInviteOwnerDialog(props : ManagerInviteOwnerDialogProps) {
    ...
    async function handleFormSubmit(data : InviteFormData) {
        ...
        const invite = await InviteService.inviteOwner(data.email, props.apartmentId);
